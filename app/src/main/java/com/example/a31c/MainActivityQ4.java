...
public class MainActivityQ4 extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (answer == 0 | answer == 3 | answer > 4) {  // check for empty input or multiple
                    Toast.makeText(MainActivityQ4.this, getString(R.string.invalidAnswer), Toast.LENGTH_LONG).show();
                }
                else {  // transition to answer activity with answer value
                    Intent intent = new Intent(MainActivityQ4.this, MainActivityA4.class);
